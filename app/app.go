...
func New(
	...
	app.ThesisKeeper = *thesismodulekeeper.NewKeeper(
		appCodec,
		keys[thesismoduletypes.StoreKey],
		keys[thesismoduletypes.MemStoreKey],
		app.GetSubspace(thesismoduletypes.ModuleName),
	)
