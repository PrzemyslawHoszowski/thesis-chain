...
function createBaseRoles(): Roles {
  return { index: "", admins: [], editors: [], signers: [], viewers: [] };
}

export const Roles = {
  encode(message: Roles, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<Roles>, I>>(object: I): Roles {
    const message = createBaseRoles();
